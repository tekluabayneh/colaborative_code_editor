...
export default function Files() {
    ...
    const getFileIcon = (fileType: string) => {
        ...
        switch (fileType) {
            case "image":
                // @ts-expect-error  alt is needed
                return <Image className={`${baseClass} text-emerald-400`} alt="" />;
            case "document":
                return <FileText className={`${baseClass} text-blue-400`} />;
            case "video":
                return <Video className={`${baseClass} text-red-400`} />;
            case "audio":
                return <Music className={`${baseClass} text-purple-400`} />;
            case "archive":
                return <Archive className={`${baseClass} text-orange-400`} />;
            case "code":
                return <Code className={`${baseClass} text-green-400`} />;
            default:
